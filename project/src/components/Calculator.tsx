...
export const Calculator: React.FC = () => {
  ...
  }, [display, hasError, waitingForOperand, clear]);
  ...
  const calculatePercentage = useCallback(() => {
    ...
    setExpression(prev => prev.replace(/[^+\-×÷]*$/, String(result)));
  }, [display, hasError]);
  ...
  return (
    <div className="max-w-sm mx-auto bg-black rounded-3xl p-6 shadow-2xl">
      ...
      <div className="grid grid-cols-4 gap-3 mt-6">
        ...
        <Button
          onClick={backspace}
          className="bg-gray-300 hover:bg-gray-200 text-black font-semibold flex items-center justify-center"
        >
          <Delete size={20} />
        </Button>
        <Button
